...
namespace SystemKnowledgeMVC.Controllers
{
    public class UsersController : Controller
    {
        ...
        public ActionResult SearchByCity(string searchString)
        {
            var users = from m in db.Users
                        select m;
            ...
            if (!String.IsNullOrEmpty(searchString))
            {
                users = users.Where(s => s.City.Contains(searchString));
            }
        ...
        public ActionResult Create([Bind(Include = "ID,FirstName,LastName,Country,City,Address,Email,Birthdate,Mobilephone,isAdmin")] User user)
        {
